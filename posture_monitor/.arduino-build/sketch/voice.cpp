#line 1 "C:\\Users\\Tanfu\\Desktop\\2026\\software\\refactored\\posture_monitor\\voice.cpp"
#include "voice.h"
...
static void _voiceSendRaw(const char* text, bool appendCrlf) {
    if (text == NULL) {
        return;
    }
...
static bool _voiceSendKnownPacketByText(const char* text) {
    if (text == NULL) {
        return false;
    }
